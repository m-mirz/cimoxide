...
pub struct PowerSystemStabilizerUserDefined {
    #[serde(flatten)]
...
impl crate::base::CimElement for PowerSystemStabilizerUserDefined {
    fn mrid(&self) -> &str { &self.base.base.base.id }
    fn type_name(&self) -> &'static str { "PowerSystemStabilizerUserDefined" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "PowerSystemStabilizerUserDefined".to_string();
        if let Some(v) = self.proprietary {
            block.fields.insert("PowerSystemStabilizerUserDefined.proprietary".into(), crate::base::FieldValue::Text(v.to_string()));
        }
        block
    }
}

impl PowerSystemStabilizerUserDefined {
