...
pub struct PowerSystemStabilizerDynamics {
    #[serde(flatten)]
...
impl crate::base::CimElement for PowerSystemStabilizerDynamics {
    fn mrid(&self) -> &str { &self.base.base.id }
    fn type_name(&self) -> &'static str { "PowerSystemStabilizerDynamics" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "PowerSystemStabilizerDynamics".to_string();
        if let Some(ref v) = self.excitation_system_dynamics {
            block.fields.insert("PowerSystemStabilizerDynamics.ExcitationSystemDynamics".into(), crate::base::FieldValue::Resource(v.mrid.clone()));
        }
        block
    }
}

impl PowerSystemStabilizerDynamics {
