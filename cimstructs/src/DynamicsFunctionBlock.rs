...
pub struct DynamicsFunctionBlock {
    #[serde(flatten)]
...
impl crate::base::CimElement for DynamicsFunctionBlock {
    fn mrid(&self) -> &str { &self.base.id }
    fn type_name(&self) -> &'static str { "DynamicsFunctionBlock" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "DynamicsFunctionBlock".to_string();
        if let Some(v) = self.enabled {
            block.fields.insert("DynamicsFunctionBlock.enabled".into(), crate::base::FieldValue::Text(v.to_string()));
        }
        block
    }
}

impl DynamicsFunctionBlock {
