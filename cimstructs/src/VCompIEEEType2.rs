...
impl crate::base::CimElement for VCompIEEEType2 {
    fn mrid(&self) -> &str { &self.base.base.base.id }
    fn type_name(&self) -> &'static str { "VCompIEEEType2" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "VCompIEEEType2".to_string();
        if let Some(v) = self.tr {
            block.fields.insert("VCompIEEEType2.tr".into(), crate::base::FieldValue::Text(v.to_string()));
        }
        block
    }
}
