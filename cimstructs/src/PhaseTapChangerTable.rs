...
pub struct PhaseTapChangerTable {
    #[serde(flatten)]
    pub base: super::IdentifiedObject,
}
impl crate::base::CimElement for PhaseTapChangerTable {
    fn mrid(&self) -> &str { &self.base.id }
    fn type_name(&self) -> &'static str { "PhaseTapChangerTable" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "PhaseTapChangerTable".to_string();
        block
    }
}

impl PhaseTapChangerTable {
