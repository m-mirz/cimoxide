...
impl crate::base::CimElement for EnergyConnection {
    fn mrid(&self) -> &str { &self.base.base.base.base.id }
    fn type_name(&self) -> &'static str { "EnergyConnection" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "EnergyConnection".to_string();
        block
    }
}

impl EnergyConnection {
