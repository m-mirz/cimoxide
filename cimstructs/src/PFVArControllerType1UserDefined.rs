...
pub struct PFVArControllerType1UserDefined {
    #[serde(flatten)]
...
impl crate::base::CimElement for PFVArControllerType1UserDefined {
    fn mrid(&self) -> &str { &self.base.base.base.id }
    fn type_name(&self) -> &'static str { "PFVArControllerType1UserDefined" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "PFVArControllerType1UserDefined".to_string();
        if let Some(v) = self.proprietary {
            block.fields.insert("PFVArControllerType1UserDefined.proprietary".into(), crate::base::FieldValue::Text(v.to_string()));
        }
        block
    }
}

impl PFVArControllerType1UserDefined {
