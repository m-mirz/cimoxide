...
pub struct VoltageCompensatorUserDefined {
    #[serde(flatten)]
...
impl crate::base::CimElement for VoltageCompensatorUserDefined {
    fn mrid(&self) -> &str { &self.base.base.base.id }
    fn type_name(&self) -> &'static str { "VoltageCompensatorUserDefined" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "VoltageCompensatorUserDefined".to_string();
        if let Some(v) = self.proprietary {
            block.fields.insert("VoltageCompensatorUserDefined.proprietary".into(), crate::base::FieldValue::Text(v.to_string()));
        }
        block
    }
}

impl VoltageCompensatorUserDefined {
