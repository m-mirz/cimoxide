...
impl crate::base::CimElement for ApparentPowerLimit {
    fn mrid(&self) -> &str { &self.base.base.id }
    fn type_name(&self) -> &'static str { "ApparentPowerLimit" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "ApparentPowerLimit".to_string();
        if let Some(v) = self.normal_value {
            block.fields.insert("ApparentPowerLimit.normalValue".into(), crate::base::FieldValue::Text(v.to_string()));
        }
        if let Some(v) = self.value {
            block.fields.insert("ApparentPowerLimit.value".into(), crate::base::FieldValue::Text(v.to_string()));
        }
        block
    }
}

impl ApparentPowerLimit {
