...
pub struct PostLineSensor {
    #[serde(flatten)]
    pub base: super::Sensor,
}
impl crate::base::CimElement for PostLineSensor {
    fn mrid(&self) -> &str { &self.base.base.base.base.base.id }
    fn type_name(&self) -> &'static str { "PostLineSensor" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "PostLineSensor".to_string();
        block
    }
}
