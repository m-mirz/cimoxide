...
pub struct PhotoVoltaicUnit {
    #[serde(flatten)]
    pub base: super::PowerElectronicsUnit,
}
impl crate::base::CimElement for PhotoVoltaicUnit {
    fn mrid(&self) -> &str { &self.base.base.base.base.id }
    fn type_name(&self) -> &'static str { "PhotoVoltaicUnit" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "PhotoVoltaicUnit".to_string();
        block
    }
}

impl PhotoVoltaicUnit {
