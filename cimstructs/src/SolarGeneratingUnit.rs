...
pub struct SolarGeneratingUnit {
    #[serde(flatten)]
    pub base: super::GeneratingUnit,
    /// A solar power plant may have solar generating units.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub solar_power_plant: Option<super::base::MridRef>,
}
impl crate::base::CimElement for SolarGeneratingUnit {
    fn mrid(&self) -> &str { &self.base.base.base.base.id }
    fn type_name(&self) -> &'static str { "SolarGeneratingUnit" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "SolarGeneratingUnit".to_string();
        if let Some(ref v) = self.solar_power_plant {
            block.fields.insert("SolarGeneratingUnit.SolarPowerPlant".into(), crate::base::FieldValue::Resource(v.mrid.clone()));
        }
        block
    }
}

impl SolarGeneratingUnit {
            ...
            match key.as_str() {
                "SolarGeneratingUnit.SolarPowerPlant" => {
                    if let crate::base::FieldValue::Resource(sv) = val {
                        obj.solar_power_plant = Some(crate::base::MridRef { mrid: sv.clone() });
                    }
                }
