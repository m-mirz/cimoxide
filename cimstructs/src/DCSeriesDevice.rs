...
impl crate::base::CimElement for DCSeriesDevice {
    fn mrid(&self) -> &str { &self.base.base.base.base.id }
    fn type_name(&self) -> &'static str { "DCSeriesDevice" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "DCSeriesDevice".to_string();
        if let Some(v) = self.inductance {
            block.fields.insert("DCSeriesDevice.inductance".into(), crate::base::FieldValue::Text(v.to_string()));
        }
        if let Some(v) = self.resistance {
            block.fields.insert("DCSeriesDevice.resistance".into(), crate::base::FieldValue::Text(v.to_string()));
        }
        block
    }
}
