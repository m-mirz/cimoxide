...
pub struct TurbineLoadControllerUserDefined {
    #[serde(flatten)]
...
impl crate::base::CimElement for TurbineLoadControllerUserDefined {
    fn mrid(&self) -> &str { &self.base.base.base.id }
    fn type_name(&self) -> &'static str { "TurbineLoadControllerUserDefined" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "TurbineLoadControllerUserDefined".to_string();
        if let Some(v) = self.proprietary {
            block.fields.insert("TurbineLoadControllerUserDefined.proprietary".into(), crate::base::FieldValue::Text(v.to_string()));
        }
        block
    }
}

impl TurbineLoadControllerUserDefined {
