...
pub struct Line {
    ...
    pub region: Option<super::base::MridRef>,
}
impl crate::base::CimElement for Line {
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "Line".to_string();
        if let Some(ref v) = self.region {
            block.fields.insert("Line.Region".into(), crate::base::FieldValue::Resource(v.mrid.clone()));
        }
        block
    }
}
            ...
            match key.as_str() {
                "Line.Region" => {
                    if let crate::base::FieldValue::Resource(sv) = val {
                        obj.region = Some(crate::base::MridRef { mrid: sv.clone() });
                    }
                }
