...
pub struct AsynchronousMachineUserDefined {
    #[serde(flatten)]
...
impl crate::base::CimElement for AsynchronousMachineUserDefined {
    fn mrid(&self) -> &str { &self.base.base.base.base.id }
    fn type_name(&self) -> &'static str { "AsynchronousMachineUserDefined" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "AsynchronousMachineUserDefined".to_string();
        if let Some(v) = self.proprietary {
            block.fields.insert("AsynchronousMachineUserDefined.proprietary".into(), crate::base::FieldValue::Text(v.to_string()));
        }
        block
    }
}

impl AsynchronousMachineUserDefined {
