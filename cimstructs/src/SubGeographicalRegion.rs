...
impl crate::base::CimElement for SubGeographicalRegion {
    fn mrid(&self) -> &str { &self.base.id }
    fn type_name(&self) -> &'static str { "SubGeographicalRegion" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "SubGeographicalRegion".to_string();
        if let Some(ref v) = self.region {
            block.fields.insert("SubGeographicalRegion.Region".into(), crate::base::FieldValue::Resource(v.mrid.clone()));
        }
        block
    }
}

impl SubGeographicalRegion {
