...
pub struct ExcitationSystemDynamics {
    #[serde(flatten)]
...
impl crate::base::CimElement for ExcitationSystemDynamics {
    fn mrid(&self) -> &str { &self.base.base.id }
    fn type_name(&self) -> &'static str { "ExcitationSystemDynamics" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "ExcitationSystemDynamics".to_string();
        if let Some(ref v) = self.synchronous_machine_dynamics {
            block.fields.insert("ExcitationSystemDynamics.SynchronousMachineDynamics".into(), crate::base::FieldValue::Resource(v.mrid.clone()));
        }
        block
    }
}

impl ExcitationSystemDynamics {
