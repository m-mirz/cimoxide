...
pub struct WindGeneratingUnit {
    #[serde(flatten)]
    pub base: super::GeneratingUnit,
    /// A wind power plant may have wind generating units.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub wind_power_plant: Option<super::base::MridRef>,
    /// The kind of wind generating unit.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub wind_gen_unit_type: Option<super::base::UriRef>,
}
impl crate::base::CimElement for WindGeneratingUnit {
    fn mrid(&self) -> &str { &self.base.base.base.base.id }
    fn type_name(&self) -> &'static str { "WindGeneratingUnit" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "WindGeneratingUnit".to_string();
        if let Some(ref v) = self.wind_power_plant {
            block.fields.insert("WindGeneratingUnit.WindPowerPlant".into(), crate::base::FieldValue::Resource(v.mrid.clone()));
        }
        if let Some(ref v) = self.wind_gen_unit_type {
            block.fields.insert("WindGeneratingUnit.windGenUnitType".into(), crate::base::FieldValue::Resource(v.uri.clone()));
        }
        block
    }
}

impl WindGeneratingUnit {
            ...
            match key.as_str() {
                "WindGeneratingUnit.WindPowerPlant" => {
                    if let crate::base::FieldValue::Resource(sv) = val {
                        obj.wind_power_plant = Some(crate::base::MridRef { mrid: sv.clone() });
                    }
                }
                "WindGeneratingUnit.windGenUnitType" => {
                    if let crate::base::FieldValue::Resource(sv) = val {
                        obj.wind_gen_unit_type = Some(crate::base::UriRef { uri: sv.clone() });
                    }
                }
