...
pub struct LoadGroup {
    ...
    pub sub_load_area: Option<super::base::MridRef>,
}
impl crate::base::CimElement for LoadGroup {
    fn mrid(&self) -> &str { &self.base.id }
    fn type_name(&self) -> &'static str { "LoadGroup" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "LoadGroup".to_string();
        if let Some(ref v) = self.sub_load_area {
            block.fields.insert("LoadGroup.SubLoadArea".into(), crate::base::FieldValue::Resource(v.mrid.clone()));
        }
        block
    }
}
            ...
            match key.as_str() {
                "LoadGroup.SubLoadArea" => {
                    if let crate::base::FieldValue::Resource(sv) = val {
                        obj.sub_load_area = Some(crate::base::MridRef { mrid: sv.clone() });
                    }
                }
