...
pub struct CSCUserDefined {
    #[serde(flatten)]
    pub base: super::CSCDynamics,
...
impl crate::base::CimElement for CSCUserDefined {
    fn mrid(&self) -> &str { &self.base.base.base.base.id }
    fn type_name(&self) -> &'static str { "CSCUserDefined" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "CSCUserDefined".to_string();
        if let Some(v) = self.proprietary {
            block.fields.insert("CSCUserDefined.proprietary".into(), crate::base::FieldValue::Text(v.to_string()));
        }
        block
    }
}
            ...
            match key.as_str() {
                ...
                "CSCDynamics.CSConverter" => {
                    if let crate::base::FieldValue::Resource(sv) = val {
                        obj.base.cs_converter = Some(crate::base::MridRef { mrid: sv.clone() });
                    }
                }
