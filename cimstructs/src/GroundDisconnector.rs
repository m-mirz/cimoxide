...
pub struct GroundDisconnector {
    #[serde(flatten)]
    pub base: super::Switch,
}
impl crate::base::CimElement for GroundDisconnector {
    fn mrid(&self) -> &str { &self.base.base.base.base.base.id }
    fn type_name(&self) -> &'static str { "GroundDisconnector" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "GroundDisconnector".to_string();
        block
    }
}

impl GroundDisconnector {
