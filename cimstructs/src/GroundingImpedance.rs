...
impl crate::base::CimElement for GroundingImpedance {
    fn mrid(&self) -> &str { &self.base.base.base.base.base.id }
    fn type_name(&self) -> &'static str { "GroundingImpedance" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "GroundingImpedance".to_string();
        if let Some(v) = self.x {
            block.fields.insert("GroundingImpedance.x".into(), crate::base::FieldValue::Text(v.to_string()));
        }
        block
    }
}

impl GroundingImpedance {
