...
pub struct WindPowerPlant {
    #[serde(flatten)]
    pub base: super::PowerSystemResource,
}
impl crate::base::CimElement for WindPowerPlant {
    fn mrid(&self) -> &str { &self.base.base.id }
    fn type_name(&self) -> &'static str { "WindPowerPlant" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "WindPowerPlant".to_string();
        block
    }
}
