...
pub struct PowerElectronicsWindUnit {
    #[serde(flatten)]
    pub base: super::PowerElectronicsUnit,
}
impl crate::base::CimElement for PowerElectronicsWindUnit {
    fn mrid(&self) -> &str { &self.base.base.base.base.id }
    fn type_name(&self) -> &'static str { "PowerElectronicsWindUnit" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "PowerElectronicsWindUnit".to_string();
        block
    }
}

impl PowerElectronicsWindUnit {
