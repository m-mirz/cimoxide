...
pub struct PowerSystemResource {
    #[serde(flatten)]
    pub base: super::IdentifiedObject,
}
impl crate::base::CimElement for PowerSystemResource {
    fn mrid(&self) -> &str { &self.base.id }
    fn type_name(&self) -> &'static str { "PowerSystemResource" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "PowerSystemResource".to_string();
        block
    }
}

impl PowerSystemResource {
