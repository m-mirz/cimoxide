...
impl crate::base::CimElement for DCGround {
    fn mrid(&self) -> &str { &self.base.base.base.base.id }
    fn type_name(&self) -> &'static str { "DCGround" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "DCGround".to_string();
        if let Some(v) = self.inductance {
            block.fields.insert("DCGround.inductance".into(), crate::base::FieldValue::Text(v.to_string()));
        }
        if let Some(v) = self.r {
            block.fields.insert("DCGround.r".into(), crate::base::FieldValue::Text(v.to_string()));
        }
        block
    }
}
