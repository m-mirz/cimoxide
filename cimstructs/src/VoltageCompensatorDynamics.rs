...
pub struct VoltageCompensatorDynamics {
    #[serde(flatten)]
...
impl crate::base::CimElement for VoltageCompensatorDynamics {
    fn mrid(&self) -> &str { &self.base.base.id }
    fn type_name(&self) -> &'static str { "VoltageCompensatorDynamics" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "VoltageCompensatorDynamics".to_string();
        if let Some(ref v) = self.excitation_system_dynamics {
            block.fields.insert("VoltageCompensatorDynamics.ExcitationSystemDynamics".into(), crate::base::FieldValue::Resource(v.mrid.clone()));
        }
        block
    }
}

impl VoltageCompensatorDynamics {
