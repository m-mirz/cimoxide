...
pub struct UnderexcitationLimiterDynamics {
    #[serde(flatten)]
...
impl crate::base::CimElement for UnderexcitationLimiterDynamics {
    fn mrid(&self) -> &str { &self.base.base.id }
    fn type_name(&self) -> &'static str { "UnderexcitationLimiterDynamics" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "UnderexcitationLimiterDynamics".to_string();
        if let Some(ref v) = self.excitation_system_dynamics {
            block.fields.insert("UnderexcitationLimiterDynamics.ExcitationSystemDynamics".into(), crate::base::FieldValue::Resource(v.mrid.clone()));
        }
        block
    }
}

impl UnderexcitationLimiterDynamics {
