...
pub struct Bay {
    ...
    pub voltage_level: Option<super::base::MridRef>,
}
impl crate::base::CimElement for Bay {
    fn mrid(&self) -> &str { &self.base.base.base.base.id }
    fn type_name(&self) -> &'static str { "Bay" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "Bay".to_string();
        if let Some(ref v) = self.voltage_level {
            block.fields.insert("Bay.VoltageLevel".into(), crate::base::FieldValue::Resource(v.mrid.clone()));
        }
        block
    }
}
            ...
            match key.as_str() {
                "Bay.VoltageLevel" => {
                    if let crate::base::FieldValue::Resource(sv) = val {
                        obj.voltage_level = Some(crate::base::MridRef { mrid: sv.clone() });
                    }
                }
