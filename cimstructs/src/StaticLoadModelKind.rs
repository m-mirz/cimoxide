...
impl StaticLoadModelKind {
    pub fn uri(&self) -> &'static str {
        match self {
            StaticLoadModelKind::exponential => "http://iec.ch/TC57/CIM100#StaticLoadModelKind.exponential",
            StaticLoadModelKind::zIP1 => "http://iec.ch/TC57/CIM100#StaticLoadModelKind.zIP1",
            StaticLoadModelKind::zIP2 => "http://iec.ch/TC57/CIM100#StaticLoadModelKind.zIP2",
            StaticLoadModelKind::constantZ => "http://iec.ch/TC57/CIM100#StaticLoadModelKind.constantZ",
        }
    }
}
