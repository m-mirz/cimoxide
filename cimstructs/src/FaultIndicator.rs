...
pub struct FaultIndicator {
    #[serde(flatten)]
    pub base: super::AuxiliaryEquipment,
}
impl crate::base::CimElement for FaultIndicator {
    fn mrid(&self) -> &str { &self.base.base.base.base.id }
    fn type_name(&self) -> &'static str { "FaultIndicator" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "FaultIndicator".to_string();
        block
    }
}
