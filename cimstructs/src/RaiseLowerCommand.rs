...
impl crate::base::CimElement for RaiseLowerCommand {
    fn mrid(&self) -> &str { &self.base.base.base.base.id }
    fn type_name(&self) -> &'static str { "RaiseLowerCommand" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "RaiseLowerCommand".to_string();
        if let Some(ref v) = self.value_alias_set {
            block.fields.insert("RaiseLowerCommand.ValueAliasSet".into(), crate::base::FieldValue::Resource(v.mrid.clone()));
        }
        block
    }
}

impl RaiseLowerCommand {
