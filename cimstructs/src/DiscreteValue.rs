...
pub struct DiscreteValue {
    ...
    pub discrete: Option<super::base::MridRef>,
}
impl crate::base::CimElement for DiscreteValue {
    fn mrid(&self) -> &str { &self.base.base.base.id }
    fn type_name(&self) -> &'static str { "DiscreteValue" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "DiscreteValue".to_string();
        if let Some(ref v) = self.discrete {
            block.fields.insert("DiscreteValue.Discrete".into(), crate::base::FieldValue::Resource(v.mrid.clone()));
        }
        block
    }
}
            ...
            match key.as_str() {
                "DiscreteValue.Discrete" => {
                    if let crate::base::FieldValue::Resource(sv) = val {
                        obj.discrete = Some(crate::base::MridRef { mrid: sv.clone() });
                    }
                }
