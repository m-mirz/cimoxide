...
pub struct TurbineGovernorUserDefined {
    #[serde(flatten)]
...
impl crate::base::CimElement for TurbineGovernorUserDefined {
    fn mrid(&self) -> &str { &self.base.base.base.id }
    fn type_name(&self) -> &'static str { "TurbineGovernorUserDefined" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "TurbineGovernorUserDefined".to_string();
        if let Some(v) = self.proprietary {
            block.fields.insert("TurbineGovernorUserDefined.proprietary".into(), crate::base::FieldValue::Text(v.to_string()));
        }
        block
    }
}

impl TurbineGovernorUserDefined {
