...
pub struct RatioTapChangerTable {
    #[serde(flatten)]
    pub base: super::IdentifiedObject,
}
impl crate::base::CimElement for RatioTapChangerTable {
    fn mrid(&self) -> &str { &self.base.id }
    fn type_name(&self) -> &'static str { "RatioTapChangerTable" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "RatioTapChangerTable".to_string();
        block
    }
}

impl RatioTapChangerTable {
