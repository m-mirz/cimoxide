...
impl crate::base::CimElement for ConductingEquipment {
    fn mrid(&self) -> &str { &self.base.base.base.id }
    fn type_name(&self) -> &'static str { "ConductingEquipment" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "ConductingEquipment".to_string();
        if let Some(ref v) = self.base_voltage {
            block.fields.insert("ConductingEquipment.BaseVoltage".into(), crate::base::FieldValue::Resource(v.mrid.clone()));
        }
        block
    }
}
