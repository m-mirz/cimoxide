...
impl crate::base::CimElement for EquivalentShunt {
    fn mrid(&self) -> &str { &self.base.base.base.base.base.id }
    fn type_name(&self) -> &'static str { "EquivalentShunt" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "EquivalentShunt".to_string();
        if let Some(v) = self.b {
            block.fields.insert("EquivalentShunt.b".into(), crate::base::FieldValue::Text(v.to_string()));
        }
        if let Some(v) = self.g {
            block.fields.insert("EquivalentShunt.g".into(), crate::base::FieldValue::Text(v.to_string()));
        }
        block
    }
}

impl EquivalentShunt {
