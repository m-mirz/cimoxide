...
pub struct VoltageAdjusterUserDefined {
    #[serde(flatten)]
...
impl crate::base::CimElement for VoltageAdjusterUserDefined {
    fn mrid(&self) -> &str { &self.base.base.base.id }
    fn type_name(&self) -> &'static str { "VoltageAdjusterUserDefined" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "VoltageAdjusterUserDefined".to_string();
        if let Some(v) = self.proprietary {
            block.fields.insert("VoltageAdjusterUserDefined.proprietary".into(), crate::base::FieldValue::Text(v.to_string()));
        }
        block
    }
}

impl VoltageAdjusterUserDefined {
