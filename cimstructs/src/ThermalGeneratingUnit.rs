...
pub struct ThermalGeneratingUnit {
    #[serde(flatten)]
    pub base: super::GeneratingUnit,
    /// A thermal generating unit may be a member of a compressed air energy storage plant.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub caes_plant: Option<super::base::MridRef>,
    /// A thermal generating unit may be a member of a cogeneration plant.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub cogeneration_plant: Option<super::base::MridRef>,
    /// A thermal generating unit may be a member of a combined cycle plant.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub combined_cycle_plant: Option<super::base::MridRef>,
}
impl crate::base::CimElement for ThermalGeneratingUnit {
    fn mrid(&self) -> &str { &self.base.base.base.base.id }
    fn type_name(&self) -> &'static str { "ThermalGeneratingUnit" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "ThermalGeneratingUnit".to_string();
        if let Some(ref v) = self.caes_plant {
            block.fields.insert("ThermalGeneratingUnit.CAESPlant".into(), crate::base::FieldValue::Resource(v.mrid.clone()));
        }
        if let Some(ref v) = self.cogeneration_plant {
            block.fields.insert("ThermalGeneratingUnit.CogenerationPlant".into(), crate::base::FieldValue::Resource(v.mrid.clone()));
        }
        if let Some(ref v) = self.combined_cycle_plant {
            block.fields.insert("ThermalGeneratingUnit.CombinedCyclePlant".into(), crate::base::FieldValue::Resource(v.mrid.clone()));
        }
        block
    }
}

impl ThermalGeneratingUnit {
            ...
            match key.as_str() {
                "ThermalGeneratingUnit.CAESPlant" => {
                    if let crate::base::FieldValue::Resource(sv) = val {
                        obj.caes_plant = Some(crate::base::MridRef { mrid: sv.clone() });
                    }
                }
                "ThermalGeneratingUnit.CogenerationPlant" => {
                    if let crate::base::FieldValue::Resource(sv) = val {
                        obj.cogeneration_plant = Some(crate::base::MridRef { mrid: sv.clone() });
                    }
                }
                "ThermalGeneratingUnit.CombinedCyclePlant" => {
                    if let crate::base::FieldValue::Resource(sv) = val {
                        obj.combined_cycle_plant = Some(crate::base::MridRef { mrid: sv.clone() });
                    }
                }
