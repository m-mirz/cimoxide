...
pub struct TurbineGovernorDynamics {
    #[serde(flatten)]
...
impl crate::base::CimElement for TurbineGovernorDynamics {
    fn mrid(&self) -> &str { &self.base.base.id }
    fn type_name(&self) -> &'static str { "TurbineGovernorDynamics" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "TurbineGovernorDynamics".to_string();
        if let Some(ref v) = self.asynchronous_machine_dynamics {
            block.fields.insert("TurbineGovernorDynamics.AsynchronousMachineDynamics".into(), crate::base::FieldValue::Resource(v.mrid.clone()));
        }
        if let Some(ref v) = self.synchronous_machine_dynamics {
            block.fields.insert("TurbineGovernorDynamics.SynchronousMachineDynamics".into(), crate::base::FieldValue::Resource(v.mrid.clone()));
        }
        block
    }
}

impl TurbineGovernorDynamics {
