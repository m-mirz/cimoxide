...
impl crate::base::CimElement for LoadUserDefined {
    fn mrid(&self) -> &str { &self.base.base.id }
    fn type_name(&self) -> &'static str { "LoadUserDefined" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "LoadUserDefined".to_string();
        if let Some(v) = self.proprietary {
            block.fields.insert("LoadUserDefined.proprietary".into(), crate::base::FieldValue::Text(v.to_string()));
        }
        block
    }
}

impl LoadUserDefined {
