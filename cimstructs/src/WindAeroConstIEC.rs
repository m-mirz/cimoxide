...
pub struct WindAeroConstIEC {
    #[serde(flatten)]
    pub base: super::IdentifiedObject,
}
impl crate::base::CimElement for WindAeroConstIEC {
    fn mrid(&self) -> &str { &self.base.id }
    fn type_name(&self) -> &'static str { "WindAeroConstIEC" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "WindAeroConstIEC".to_string();
        block
    }
}

impl WindAeroConstIEC {
