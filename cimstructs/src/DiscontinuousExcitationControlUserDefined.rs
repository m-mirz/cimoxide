...
pub struct DiscontinuousExcitationControlUserDefined {
    #[serde(flatten)]
...
impl crate::base::CimElement for DiscontinuousExcitationControlUserDefined {
    fn mrid(&self) -> &str { &self.base.base.base.id }
    fn type_name(&self) -> &'static str { "DiscontinuousExcitationControlUserDefined" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "DiscontinuousExcitationControlUserDefined".to_string();
        if let Some(v) = self.proprietary {
            block.fields.insert("DiscontinuousExcitationControlUserDefined.proprietary".into(), crate::base::FieldValue::Text(v.to_string()));
        }
        block
    }
}

impl DiscontinuousExcitationControlUserDefined {
