...
pub struct ExcitationSystemUserDefined {
    #[serde(flatten)]
...
impl crate::base::CimElement for ExcitationSystemUserDefined {
    fn mrid(&self) -> &str { &self.base.base.base.id }
    fn type_name(&self) -> &'static str { "ExcitationSystemUserDefined" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "ExcitationSystemUserDefined".to_string();
        if let Some(v) = self.proprietary {
            block.fields.insert("ExcitationSystemUserDefined.proprietary".into(), crate::base::FieldValue::Text(v.to_string()));
        }
        block
    }
}

impl ExcitationSystemUserDefined {
