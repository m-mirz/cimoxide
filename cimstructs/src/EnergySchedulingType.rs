...
pub struct EnergySchedulingType {
    #[serde(flatten)]
    pub base: super::IdentifiedObject,
}
impl crate::base::CimElement for EnergySchedulingType {
    fn mrid(&self) -> &str { &self.base.id }
    fn type_name(&self) -> &'static str { "EnergySchedulingType" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "EnergySchedulingType".to_string();
        block
    }
}

impl EnergySchedulingType {
