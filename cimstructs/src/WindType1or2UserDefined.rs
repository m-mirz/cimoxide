...
pub struct WindType1or2UserDefined {
    #[serde(flatten)]
...
impl crate::base::CimElement for WindType1or2UserDefined {
    fn mrid(&self) -> &str { &self.base.base.base.id }
    fn type_name(&self) -> &'static str { "WindType1or2UserDefined" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "WindType1or2UserDefined".to_string();
        if let Some(v) = self.proprietary {
            block.fields.insert("WindType1or2UserDefined.proprietary".into(), crate::base::FieldValue::Text(v.to_string()));
        }
        block
    }
}

impl WindType1or2UserDefined {
