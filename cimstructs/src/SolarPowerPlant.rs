...
pub struct SolarPowerPlant {
    #[serde(flatten)]
    pub base: super::PowerSystemResource,
}
impl crate::base::CimElement for SolarPowerPlant {
    fn mrid(&self) -> &str { &self.base.base.id }
    fn type_name(&self) -> &'static str { "SolarPowerPlant" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "SolarPowerPlant".to_string();
        block
    }
}

impl SolarPowerPlant {
