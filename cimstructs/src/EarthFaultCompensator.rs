...
pub struct EarthFaultCompensator {
    #[serde(flatten)]
...
impl crate::base::CimElement for EarthFaultCompensator {
    fn mrid(&self) -> &str { &self.base.base.base.base.id }
    fn type_name(&self) -> &'static str { "EarthFaultCompensator" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "EarthFaultCompensator".to_string();
        if let Some(v) = self.r {
            block.fields.insert("EarthFaultCompensator.r".into(), crate::base::FieldValue::Text(v.to_string()));
        }
        block
    }
}

impl EarthFaultCompensator {
