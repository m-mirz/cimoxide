...
impl crate::base::CimElement for Conductor {
    fn mrid(&self) -> &str { &self.base.base.base.base.id }
    fn type_name(&self) -> &'static str { "Conductor" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "Conductor".to_string();
        if let Some(v) = self.length {
            block.fields.insert("Conductor.length".into(), crate::base::FieldValue::Text(v.to_string()));
        }
        block
    }
}
