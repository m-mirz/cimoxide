...
pub struct MeasurementValueSource {
    #[serde(flatten)]
    pub base: super::IdentifiedObject,
}
impl crate::base::CimElement for MeasurementValueSource {
    fn mrid(&self) -> &str { &self.base.id }
    fn type_name(&self) -> &'static str { "MeasurementValueSource" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "MeasurementValueSource".to_string();
        block
    }
}

impl MeasurementValueSource {
