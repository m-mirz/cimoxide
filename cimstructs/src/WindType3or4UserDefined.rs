...
pub struct WindType3or4UserDefined {
    #[serde(flatten)]
...
impl crate::base::CimElement for WindType3or4UserDefined {
    fn mrid(&self) -> &str { &self.base.base.base.id }
    fn type_name(&self) -> &'static str { "WindType3or4UserDefined" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "WindType3or4UserDefined".to_string();
        if let Some(v) = self.proprietary {
            block.fields.insert("WindType3or4UserDefined.proprietary".into(), crate::base::FieldValue::Text(v.to_string()));
        }
        block
    }
}

impl WindType3or4UserDefined {
