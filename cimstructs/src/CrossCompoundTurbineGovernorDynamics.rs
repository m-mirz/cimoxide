...
pub struct CrossCompoundTurbineGovernorDynamics {
    #[serde(flatten)]
    ...
    pub high_pressure_synchronous_machine_dynamics: Option<super::base::MridRef>,
    /// Low-pressure synchronous machine with which this cross-compound turbine governor is associated.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub low_pressure_synchronous_machine_dynamics: Option<super::base::MridRef>,
}
impl crate::base::CimElement for CrossCompoundTurbineGovernorDynamics {
    fn mrid(&self) -> &str { &self.base.base.id }
    fn type_name(&self) -> &'static str { "CrossCompoundTurbineGovernorDynamics" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "CrossCompoundTurbineGovernorDynamics".to_string();
        if let Some(ref v) = self.high_pressure_synchronous_machine_dynamics {
            block.fields.insert("CrossCompoundTurbineGovernorDynamics.HighPressureSynchronousMachineDynamics".into(), crate::base::FieldValue::Resource(v.mrid.clone()));
        }
        if let Some(ref v) = self.low_pressure_synchronous_machine_dynamics {
            block.fields.insert("CrossCompoundTurbineGovernorDynamics.LowPressureSynchronousMachineDynamics".into(), crate::base::FieldValue::Resource(v.mrid.clone()));
        }
        block
    }
}

impl CrossCompoundTurbineGovernorDynamics {
            ...
            match key.as_str() {
                "CrossCompoundTurbineGovernorDynamics.HighPressureSynchronousMachineDynamics" => {
                    if let crate::base::FieldValue::Resource(sv) = val {
                        obj.high_pressure_synchronous_machine_dynamics = Some(crate::base::MridRef { mrid: sv.clone() });
                    }
                }
                "CrossCompoundTurbineGovernorDynamics.LowPressureSynchronousMachineDynamics" => {
                    if let crate::base::FieldValue::Resource(sv) = val {
                        obj.low_pressure_synchronous_machine_dynamics = Some(crate::base::MridRef { mrid: sv.clone() });
                    }
                }
