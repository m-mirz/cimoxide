...
pub struct ReportingGroup {
    #[serde(flatten)]
    pub base: super::IdentifiedObject,
}
impl crate::base::CimElement for ReportingGroup {
    fn mrid(&self) -> &str { &self.base.id }
    fn type_name(&self) -> &'static str { "ReportingGroup" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "ReportingGroup".to_string();
        block
    }
}
