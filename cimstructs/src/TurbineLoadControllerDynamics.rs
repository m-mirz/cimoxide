...
pub struct TurbineLoadControllerDynamics {
    #[serde(flatten)]
    pub base: super::DynamicsFunctionBlock,
    /// Turbine-governor controlled by this turbine load controller.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub turbine_governor_dynamics: Option<super::base::MridRef>,
}
impl crate::base::CimElement for TurbineLoadControllerDynamics {
    fn mrid(&self) -> &str { &self.base.base.id }
    fn type_name(&self) -> &'static str { "TurbineLoadControllerDynamics" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "TurbineLoadControllerDynamics".to_string();
        if let Some(ref v) = self.turbine_governor_dynamics {
            block.fields.insert("TurbineLoadControllerDynamics.TurbineGovernorDynamics".into(), crate::base::FieldValue::Resource(v.mrid.clone()));
        }
        block
    }
}

impl TurbineLoadControllerDynamics {
            ...
            match key.as_str() {
                "TurbineLoadControllerDynamics.TurbineGovernorDynamics" => {
                    if let crate::base::FieldValue::Resource(sv) = val {
                        obj.turbine_governor_dynamics = Some(crate::base::MridRef { mrid: sv.clone() });
                    }
                }
