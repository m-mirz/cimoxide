...
pub struct PotentialTransformer {
    #[serde(flatten)]
    pub base: super::Sensor,
}
impl crate::base::CimElement for PotentialTransformer {
    fn mrid(&self) -> &str { &self.base.base.base.base.base.id }
    fn type_name(&self) -> &'static str { "PotentialTransformer" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "PotentialTransformer".to_string();
        block
    }
}

impl PotentialTransformer {
            ...
            match key.as_str() {
                "AuxiliaryEquipment.Terminal" => {
                    if let crate::base::FieldValue::Resource(sv) = val {
                        obj.base.base.terminal = Some(crate::base::MridRef { mrid: sv.clone() });
                    }
                }
