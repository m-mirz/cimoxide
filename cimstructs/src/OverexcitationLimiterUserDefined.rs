...
pub struct OverexcitationLimiterUserDefined {
    #[serde(flatten)]
...
impl crate::base::CimElement for OverexcitationLimiterUserDefined {
    fn mrid(&self) -> &str { &self.base.base.base.id }
    fn type_name(&self) -> &'static str { "OverexcitationLimiterUserDefined" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "OverexcitationLimiterUserDefined".to_string();
        if let Some(v) = self.proprietary {
            block.fields.insert("OverexcitationLimiterUserDefined.proprietary".into(), crate::base::FieldValue::Text(v.to_string()));
        }
        block
    }
}

impl OverexcitationLimiterUserDefined {
