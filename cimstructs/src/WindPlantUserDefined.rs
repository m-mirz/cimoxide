...
pub struct WindPlantUserDefined {
    #[serde(flatten)]
...
impl crate::base::CimElement for WindPlantUserDefined {
    fn mrid(&self) -> &str { &self.base.base.base.id }
    fn type_name(&self) -> &'static str { "WindPlantUserDefined" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "WindPlantUserDefined".to_string();
        if let Some(v) = self.proprietary {
            block.fields.insert("WindPlantUserDefined.proprietary".into(), crate::base::FieldValue::Text(v.to_string()));
        }
        block
    }
}

impl WindPlantUserDefined {
