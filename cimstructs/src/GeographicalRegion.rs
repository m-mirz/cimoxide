...
impl crate::base::CimElement for GeographicalRegion {
    fn mrid(&self) -> &str { &self.base.id }
    fn type_name(&self) -> &'static str { "GeographicalRegion" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "GeographicalRegion".to_string();
        block
    }
}

impl GeographicalRegion {
