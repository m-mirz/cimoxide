...
pub struct ConnectivityNodeContainer {
    #[serde(flatten)]
    pub base: super::PowerSystemResource,
}
impl crate::base::CimElement for ConnectivityNodeContainer {
    fn mrid(&self) -> &str { &self.base.base.id }
    fn type_name(&self) -> &'static str { "ConnectivityNodeContainer" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "ConnectivityNodeContainer".to_string();
        block
    }
}

impl ConnectivityNodeContainer {
