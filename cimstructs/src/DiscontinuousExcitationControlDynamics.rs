...
pub struct DiscontinuousExcitationControlDynamics {
    #[serde(flatten)]
    ...
    pub excitation_system_dynamics: Option<super::base::MridRef>,
}
impl crate::base::CimElement for DiscontinuousExcitationControlDynamics {
    fn mrid(&self) -> &str { &self.base.base.id }
    fn type_name(&self) -> &'static str { "DiscontinuousExcitationControlDynamics" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "DiscontinuousExcitationControlDynamics".to_string();
        if let Some(ref v) = self.excitation_system_dynamics {
            block.fields.insert("DiscontinuousExcitationControlDynamics.ExcitationSystemDynamics".into(), crate::base::FieldValue::Resource(v.mrid.clone()));
        }
        block
    }
}

impl DiscontinuousExcitationControlDynamics {
            ...
            match key.as_str() {
                "DiscontinuousExcitationControlDynamics.ExcitationSystemDynamics" => {
                    if let crate::base::FieldValue::Resource(sv) = val {
                        obj.excitation_system_dynamics = Some(crate::base::MridRef { mrid: sv.clone() });
                    }
                }
