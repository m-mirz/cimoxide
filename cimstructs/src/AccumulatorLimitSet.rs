...
impl crate::base::CimElement for AccumulatorLimitSet {
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "AccumulatorLimitSet".to_string();
        if !self.measurements.is_empty() {
            block.fields.insert("AccumulatorLimitSet.Measurements".into(), crate::base::FieldValue::ResourceList(self.measurements.iter().map(|r| r.mrid.clone()).collect()));
        }
        block
    }
}

impl AccumulatorLimitSet {
