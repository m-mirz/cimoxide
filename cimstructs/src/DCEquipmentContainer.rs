...
pub struct DCEquipmentContainer {
    #[serde(flatten)]
    pub base: super::EquipmentContainer,
}
impl crate::base::CimElement for DCEquipmentContainer {
    fn mrid(&self) -> &str { &self.base.base.base.base.id }
    fn type_name(&self) -> &'static str { "DCEquipmentContainer" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "DCEquipmentContainer".to_string();
        block
    }
}

impl DCEquipmentContainer {
