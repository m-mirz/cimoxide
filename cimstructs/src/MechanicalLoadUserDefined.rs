...
pub struct MechanicalLoadUserDefined {
    #[serde(flatten)]
...
impl crate::base::CimElement for MechanicalLoadUserDefined {
    fn mrid(&self) -> &str { &self.base.base.base.id }
    fn type_name(&self) -> &'static str { "MechanicalLoadUserDefined" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "MechanicalLoadUserDefined".to_string();
        if let Some(v) = self.proprietary {
            block.fields.insert("MechanicalLoadUserDefined.proprietary".into(), crate::base::FieldValue::Text(v.to_string()));
        }
        block
    }
}

impl MechanicalLoadUserDefined {
