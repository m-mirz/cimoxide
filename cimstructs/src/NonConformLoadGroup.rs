...
pub struct NonConformLoadGroup {
    #[serde(flatten)]
    pub base: super::LoadGroup,
}
impl crate::base::CimElement for NonConformLoadGroup {
    fn mrid(&self) -> &str { &self.base.base.id }
    fn type_name(&self) -> &'static str { "NonConformLoadGroup" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "NonConformLoadGroup".to_string();
        block
    }
}

impl NonConformLoadGroup {
            ...
            match key.as_str() {
                "LoadGroup.SubLoadArea" => {
                    if let crate::base::FieldValue::Resource(sv) = val {
                        obj.base.sub_load_area = Some(crate::base::MridRef { mrid: sv.clone() });
                    }
                }
