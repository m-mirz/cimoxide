...
impl crate::base::CimElement for DCTopologicalNode {
    fn mrid(&self) -> &str { &self.base.id }
    fn type_name(&self) -> &'static str { "DCTopologicalNode" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "DCTopologicalNode".to_string();
        if let Some(ref v) = self.dc_equipment_container {
            block.fields.insert("DCTopologicalNode.DCEquipmentContainer".into(), crate::base::FieldValue::Resource(v.mrid.clone()));
        }
        block
    }
}

impl DCTopologicalNode {
