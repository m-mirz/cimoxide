...
pub struct ConformLoadGroup {
    #[serde(flatten)]
    pub base: super::LoadGroup,
}
impl crate::base::CimElement for ConformLoadGroup {
    fn mrid(&self) -> &str { &self.base.base.id }
    fn type_name(&self) -> &'static str { "ConformLoadGroup" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "ConformLoadGroup".to_string();
        block
    }
}

impl ConformLoadGroup {
