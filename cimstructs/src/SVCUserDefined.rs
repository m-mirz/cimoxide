...
pub struct SVCUserDefined {
    #[serde(flatten)]
    pub base: super::StaticVarCompensatorDynamics,
...
impl crate::base::CimElement for SVCUserDefined {
    fn mrid(&self) -> &str { &self.base.base.base.id }
    fn type_name(&self) -> &'static str { "SVCUserDefined" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "SVCUserDefined".to_string();
        if let Some(v) = self.proprietary {
            block.fields.insert("SVCUserDefined.proprietary".into(), crate::base::FieldValue::Text(v.to_string()));
        }
        block
    }
}
            ...
            match key.as_str() {
                ...
                "StaticVarCompensatorDynamics.StaticVarCompensator" => {
                    if let crate::base::FieldValue::Resource(sv) = val {
                        obj.base.static_var_compensator = Some(crate::base::MridRef { mrid: sv.clone() });
                    }
                }
