...
pub struct PFVArControllerType2Dynamics {
    #[serde(flatten)]
...
impl crate::base::CimElement for PFVArControllerType2Dynamics {
    fn mrid(&self) -> &str { &self.base.base.id }
    fn type_name(&self) -> &'static str { "PFVArControllerType2Dynamics" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "PFVArControllerType2Dynamics".to_string();
        if let Some(ref v) = self.excitation_system_dynamics {
            block.fields.insert("PFVArControllerType2Dynamics.ExcitationSystemDynamics".into(), crate::base::FieldValue::Resource(v.mrid.clone()));
        }
        block
    }
}

impl PFVArControllerType2Dynamics {
