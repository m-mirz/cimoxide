...
pub struct VSCUserDefined {
    #[serde(flatten)]
    pub base: super::VSCDynamics,
...
impl crate::base::CimElement for VSCUserDefined {
    fn mrid(&self) -> &str { &self.base.base.base.base.id }
    fn type_name(&self) -> &'static str { "VSCUserDefined" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "VSCUserDefined".to_string();
        if let Some(v) = self.proprietary {
            block.fields.insert("VSCUserDefined.proprietary".into(), crate::base::FieldValue::Text(v.to_string()));
        }
        block
    }
}
            ...
            match key.as_str() {
                ...
                "VSCDynamics.VsConverter" => {
                    if let crate::base::FieldValue::Resource(sv) = val {
                        obj.base.vs_converter = Some(crate::base::MridRef { mrid: sv.clone() });
                    }
                }
