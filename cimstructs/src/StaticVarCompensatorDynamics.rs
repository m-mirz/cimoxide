...
pub struct StaticVarCompensatorDynamics {
    #[serde(flatten)]
    ...
    pub static_var_compensator: Option<super::base::MridRef>,
}
impl crate::base::CimElement for StaticVarCompensatorDynamics {
    fn mrid(&self) -> &str { &self.base.base.id }
    fn type_name(&self) -> &'static str { "StaticVarCompensatorDynamics" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "StaticVarCompensatorDynamics".to_string();
        if let Some(ref v) = self.static_var_compensator {
            block.fields.insert("StaticVarCompensatorDynamics.StaticVarCompensator".into(), crate::base::FieldValue::Resource(v.mrid.clone()));
        }
        block
    }
}

impl StaticVarCompensatorDynamics {
            ...
            match key.as_str() {
                "StaticVarCompensatorDynamics.StaticVarCompensator" => {
                    if let crate::base::FieldValue::Resource(sv) = val {
                        obj.static_var_compensator = Some(crate::base::MridRef { mrid: sv.clone() });
                    }
                }
