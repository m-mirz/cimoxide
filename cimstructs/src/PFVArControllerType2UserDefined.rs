...
pub struct PFVArControllerType2UserDefined {
    #[serde(flatten)]
...
impl crate::base::CimElement for PFVArControllerType2UserDefined {
    fn mrid(&self) -> &str { &self.base.base.base.id }
    fn type_name(&self) -> &'static str { "PFVArControllerType2UserDefined" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "PFVArControllerType2UserDefined".to_string();
        if let Some(v) = self.proprietary {
            block.fields.insert("PFVArControllerType2UserDefined.proprietary".into(), crate::base::FieldValue::Text(v.to_string()));
        }
        block
    }
}

impl PFVArControllerType2UserDefined {
