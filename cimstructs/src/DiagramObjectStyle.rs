...
pub struct DiagramObjectStyle {
    #[serde(flatten)]
    pub base: super::IdentifiedObject,
}
impl crate::base::CimElement for DiagramObjectStyle {
    fn mrid(&self) -> &str { &self.base.id }
    fn type_name(&self) -> &'static str { "DiagramObjectStyle" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "DiagramObjectStyle".to_string();
        block
    }
}

impl DiagramObjectStyle {
