...
pub struct AnalogValue {
    ...
    pub analog: Option<super::base::MridRef>,
}
impl crate::base::CimElement for AnalogValue {
    fn mrid(&self) -> &str { &self.base.base.base.id }
    fn type_name(&self) -> &'static str { "AnalogValue" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "AnalogValue".to_string();
        if let Some(ref v) = self.analog {
            block.fields.insert("AnalogValue.Analog".into(), crate::base::FieldValue::Resource(v.mrid.clone()));
        }
        block
    }
}
            ...
            match key.as_str() {
                "AnalogValue.Analog" => {
                    if let crate::base::FieldValue::Resource(sv) = val {
                        obj.analog = Some(crate::base::MridRef { mrid: sv.clone() });
                    }
                }
