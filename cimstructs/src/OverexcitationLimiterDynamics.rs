...
pub struct OverexcitationLimiterDynamics {
    #[serde(flatten)]
...
impl crate::base::CimElement for OverexcitationLimiterDynamics {
    fn mrid(&self) -> &str { &self.base.base.id }
    fn type_name(&self) -> &'static str { "OverexcitationLimiterDynamics" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "OverexcitationLimiterDynamics".to_string();
        if let Some(ref v) = self.excitation_system_dynamics {
            block.fields.insert("OverexcitationLimiterDynamics.ExcitationSystemDynamics".into(), crate::base::FieldValue::Resource(v.mrid.clone()));
        }
        block
    }
}

impl OverexcitationLimiterDynamics {
