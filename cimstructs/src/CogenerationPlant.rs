...
pub struct CogenerationPlant {
    #[serde(flatten)]
    pub base: super::PowerSystemResource,
}
impl crate::base::CimElement for CogenerationPlant {
    fn mrid(&self) -> &str { &self.base.base.id }
    fn type_name(&self) -> &'static str { "CogenerationPlant" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "CogenerationPlant".to_string();
        block
    }
}

impl CogenerationPlant {
