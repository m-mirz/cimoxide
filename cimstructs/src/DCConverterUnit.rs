...
pub struct DCConverterUnit {
    #[serde(flatten)]
    pub base: super::DCEquipmentContainer,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub operation_mode: Option<super::base::UriRef>,
}
impl crate::base::CimElement for DCConverterUnit {
    fn mrid(&self) -> &str { &self.base.base.base.base.base.id }
    fn type_name(&self) -> &'static str { "DCConverterUnit" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "DCConverterUnit".to_string();
        if let Some(ref v) = self.substation {
            block.fields.insert("DCConverterUnit.Substation".into(), crate::base::FieldValue::Resource(v.mrid.clone()));
        }
        if let Some(ref v) = self.operation_mode {
            block.fields.insert("DCConverterUnit.operationMode".into(), crate::base::FieldValue::Resource(v.uri.clone()));
        }
        block
    }
}

impl DCConverterUnit {
        ...
        for (key, val) in &b.fields {
            match key.as_str() {
                ...
                "DCConverterUnit.operationMode" => {
                    if let crate::base::FieldValue::Resource(sv) = val {
                        obj.operation_mode = Some(crate::base::UriRef { uri: sv.clone() });
                    }
                }
