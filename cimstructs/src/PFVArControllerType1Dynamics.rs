...
pub struct PFVArControllerType1Dynamics {
    #[serde(flatten)]
...
impl crate::base::CimElement for PFVArControllerType1Dynamics {
    fn mrid(&self) -> &str { &self.base.base.id }
    fn type_name(&self) -> &'static str { "PFVArControllerType1Dynamics" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "PFVArControllerType1Dynamics".to_string();
        if let Some(ref v) = self.excitation_system_dynamics {
            block.fields.insert("PFVArControllerType1Dynamics.ExcitationSystemDynamics".into(), crate::base::FieldValue::Resource(v.mrid.clone()));
        }
        block
    }
}

impl PFVArControllerType1Dynamics {
