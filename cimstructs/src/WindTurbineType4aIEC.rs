...
impl crate::base::CimElement for WindTurbineType4aIEC {
    fn mrid(&self) -> &str { &self.base.base.base.base.base.id }
    fn type_name(&self) -> &'static str { "WindTurbineType4aIEC" }
    ...
    fn to_block(&self) -> crate::base::RdfBlock {
        ...
        block.type_name = "WindTurbineType4aIEC".to_string();
        if let Some(ref v) = self.wind_cont_p_type4a_iec {
            block.fields.insert("WindTurbineType4aIEC.WindContPType4aIEC".into(), crate::base::FieldValue::Resource(v.mrid.clone()));
        }
        if let Some(ref v) = self.wind_gen_type4iec {
            block.fields.insert("WindTurbineType4aIEC.WindGenType4IEC".into(), crate::base::FieldValue::Resource(v.mrid.clone()));
        }
        block
    }
}

impl WindTurbineType4aIEC {
            ...
            match key.as_str() {
                "WindTurbineType4aIEC.WindContPType4aIEC" => {
                    if let crate::base::FieldValue::Resource(sv) = val {
                        obj.wind_cont_p_type4a_iec = Some(crate::base::MridRef { mrid: sv.clone() });
                    }
                }
