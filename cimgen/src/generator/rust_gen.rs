...
fn render_registry(spec: &CimSpecification) -> String {
    ...
    writeln!(s).unwrap();
    writeln!(s, "static REGISTRY: LazyLock<HashMap<&'static str, ParseFn>> = LazyLock::new(|| {{").unwrap();
    ...
    writeln!(s, "}});").unwrap();
    writeln!(s).unwrap();
    writeln!(s, "pub fn registry() -> &'static HashMap<&'static str, ParseFn> {{").unwrap();
    ...
    writeln!(s).unwrap();
    writeln!(s, "static JSON_REGISTRY: LazyLock<HashMap<&'static str, JsonParseFn>> = LazyLock::new(|| {{").unwrap();
    ...
    writeln!(s, "}});").unwrap();
    writeln!(s).unwrap();
    writeln!(s, "pub fn json_registry() -> &'static HashMap<&'static str, JsonParseFn> {{").unwrap();
